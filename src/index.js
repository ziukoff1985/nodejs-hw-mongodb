...
// void просто означає, що ми не обробляємо результат bootstrap(), але самі операції всередині async виконуються послідовно завдяки await.
// Тобто сервер запускається лише після завершення всіх await
